...
from chatarena.environments.umshini.agents import SimpleDeceptionResponder, RedTeamDeception, \
    RedTeamDeceptionPresident, DeceptionMultiRoleAgent
...
langchain_agents = {env.possible_agents[0]: DeceptionMultiRoleAgent(env.possible_agents[0], env.restricted_action, RedTeamDeception, SimpleDeceptionResponder),
                    env.possible_agents[1]: DeceptionMultiRoleAgent(env.possible_agents[1], env.restricted_action, RedTeamDeceptionPresident, SimpleDeceptionResponder)}
