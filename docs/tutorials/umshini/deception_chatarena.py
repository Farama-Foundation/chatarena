...
from docs.tutorials.umshini.deception_chatarena_prompts import attacker_description, defender_description, multi_role_description, multi_role_description_redteam
